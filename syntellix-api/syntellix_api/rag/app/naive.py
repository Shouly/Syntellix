...
from syntellix_api.rag.deepdoc.parser import (
    DocxParser,
    ExcelParser,
    HtmlParser,
    JsonParser,
...
from syntellix_api.rag.nlp import (
    concat_img,
    find_codec,
    naive_merge,
    naive_merge_docx,
...
if __name__ == "__main__":
    ...
    chunk("/Users/liangbing/Downloads/test.docx", from_page=0, to_page=10, callback=dummy)
